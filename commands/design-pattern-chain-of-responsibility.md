...
# /backend-best-practices:design-pattern-chain-of-responsibility

薄入口。相关 Workflow 已作为同名 Skill 注册，把 $ARGUMENTS 交给 **workflow-design-pattern**，并固定候选能力为 design-pattern-chain-of-responsibility。
